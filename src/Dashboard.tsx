...
import BookAppointment from './BookAppointment'; // Import BookAppointment component
import ProfileScreen from './Profile';
import PatientRepository from './PatientRepository'; // Adjust the path if necessary
...
const CustomDrawerContent = (props: any) => {
  ...
  label="Reports"
  icon={() => <Icon name="file-document-outline" size={24} />}
  onPress={() => navigation.navigate('PatientRepository')} // Navigate to PatientRepository
/>
...
const DashboardWithDrawer = () => {
  return (
    ...
    >
      ...
      <Drawer.Screen name="Reports" component={ReportsScreen} />
      <Drawer.Screen name="Login" component={LoginScreen} />
      <Drawer.Screen name="PatientRepository" component={PatientRepository} />
